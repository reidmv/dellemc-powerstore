...
class PowerstoreNasServerUpdateUserMappingsTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/nas_server/%{id}/update_user_mappings'
  ...
  if __FILE__ == $0
    PowerstoreNasServerUpdateUserMappingsTask.run
  end
