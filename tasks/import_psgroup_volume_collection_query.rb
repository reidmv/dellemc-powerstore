...
class PowerstoreImportPsgroupVolumeCollectionQueryTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/import_psgroup_volume'
  ...
  if __FILE__ == $0
    PowerstoreImportPsgroupVolumeCollectionQueryTask.run
  end
