...
class PowerstoreImportHostInitiatorInstanceQueryTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/import_host_initiator/%{id}'
  ...
  if __FILE__ == $0
    PowerstoreImportHostInitiatorInstanceQueryTask.run
  end
