...
class PowerstoreFileVirusCheckerDownloadConfigTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/file_virus_checker/%{id}/download_config'
  ...
  if __FILE__ == $0
    PowerstoreFileVirusCheckerDownloadConfigTask.run
  end
