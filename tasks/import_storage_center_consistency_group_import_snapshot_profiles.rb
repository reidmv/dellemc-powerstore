...
class PowerstoreImportStorageCenterConsistencyGroupImportSnapshotProfilesTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/import_storage_center_consistency_group/%{id}/import_snapshot_profiles'
  ...
  if __FILE__ == $0
    PowerstoreImportStorageCenterConsistencyGroupImportSnapshotProfilesTask.run
  end
