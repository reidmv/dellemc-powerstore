...
class PowerstoreImportStorageCenterCollectionQueryTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/import_storage_center'
  ...
  if __FILE__ == $0
    PowerstoreImportStorageCenterCollectionQueryTask.run
  end
