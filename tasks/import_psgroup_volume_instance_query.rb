...
class PowerstoreImportPsgroupVolumeInstanceQueryTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/import_psgroup_volume/%{id}'
  ...
  if __FILE__ == $0
    PowerstoreImportPsgroupVolumeInstanceQueryTask.run
  end
