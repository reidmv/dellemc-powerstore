...
class PowerstoreImportPsgroupVolumeImportSnapshotSchedulesTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/import_psgroup_volume/%{id}/import_snapshot_schedules'
  ...
  if __FILE__ == $0
    PowerstoreImportPsgroupVolumeImportSnapshotSchedulesTask.run
  end
