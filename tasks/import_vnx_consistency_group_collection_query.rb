...
class PowerstoreImportVnxConsistencyGroupCollectionQueryTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/import_vnx_consistency_group'
  ...
  if __FILE__ == $0
    PowerstoreImportVnxConsistencyGroupCollectionQueryTask.run
  end
