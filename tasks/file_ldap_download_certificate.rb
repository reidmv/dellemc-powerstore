...
class PowerstoreFileLdapDownloadCertificateTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/file_ldap/%{id}/download_certificate'
  ...
  if __FILE__ == $0
    PowerstoreFileLdapDownloadCertificateTask.run
  end
