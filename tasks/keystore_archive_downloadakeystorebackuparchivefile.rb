...
class PowerstoreKeystoreArchiveDownloadakeystorebackuparchivefileTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/keystore_archive/%{filename}'
  ...
  if __FILE__ == $0
    PowerstoreKeystoreArchiveDownloadakeystorebackuparchivefileTask.run
  end
