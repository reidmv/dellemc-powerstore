...
class PowerstoreImportStorageCenterConsistencyGroupInstanceQueryTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/import_storage_center_consistency_group/%{id}'
  ...
  if __FILE__ == $0
    PowerstoreImportStorageCenterConsistencyGroupInstanceQueryTask.run
  end
