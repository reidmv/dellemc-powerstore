...
class PowerstoreReplicationSessionReprotectTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/replication_session/%{id}/reprotect'
  ...
  if __FILE__ == $0
    PowerstoreReplicationSessionReprotectTask.run
  end
