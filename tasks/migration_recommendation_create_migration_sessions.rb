...
class PowerstoreMigrationRecommendationCreateMigrationSessionsTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/migration_recommendation/%{id}/create_migration_sessions'
  ...
  if __FILE__ == $0
    PowerstoreMigrationRecommendationCreateMigrationSessionsTask.run
  end
