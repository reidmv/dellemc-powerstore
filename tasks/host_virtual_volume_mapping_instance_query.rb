...
class PowerstoreHostVirtualVolumeMappingInstanceQueryTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/host_virtual_volume_mapping/%{id}'
  ...
  if __FILE__ == $0
    PowerstoreHostVirtualVolumeMappingInstanceQueryTask.run
  end
