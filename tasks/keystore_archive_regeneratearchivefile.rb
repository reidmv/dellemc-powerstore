...
class PowerstoreKeystoreArchiveRegeneratearchivefileTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/keystore_archive/regenerate'
  ...
  if __FILE__ == $0
    PowerstoreKeystoreArchiveRegeneratearchivefileTask.run
  end
