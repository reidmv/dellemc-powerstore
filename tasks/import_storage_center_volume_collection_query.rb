...
class PowerstoreImportStorageCenterVolumeCollectionQueryTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/import_storage_center_volume'
  ...
  if __FILE__ == $0
    PowerstoreImportStorageCenterVolumeCollectionQueryTask.run
  end
