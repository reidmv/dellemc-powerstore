...
class PowerstoreImportHostInitiatorCollectionQueryTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/import_host_initiator'
  ...
  if __FILE__ == $0
    PowerstoreImportHostInitiatorCollectionQueryTask.run
  end
