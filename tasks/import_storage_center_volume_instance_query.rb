...
class PowerstoreImportStorageCenterVolumeInstanceQueryTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/import_storage_center_volume/%{id}'
  ...
  if __FILE__ == $0
    PowerstoreImportStorageCenterVolumeInstanceQueryTask.run
  end
