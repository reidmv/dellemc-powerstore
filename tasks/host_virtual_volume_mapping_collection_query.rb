...
class PowerstoreHostVirtualVolumeMappingCollectionQueryTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/host_virtual_volume_mapping'
  ...
  if __FILE__ == $0
    PowerstoreHostVirtualVolumeMappingCollectionQueryTask.run
  end
