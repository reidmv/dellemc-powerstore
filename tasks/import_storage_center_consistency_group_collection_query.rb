...
class PowerstoreImportStorageCenterConsistencyGroupCollectionQueryTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/import_storage_center_consistency_group'
  ...
  if __FILE__ == $0
    PowerstoreImportStorageCenterConsistencyGroupCollectionQueryTask.run
  end
