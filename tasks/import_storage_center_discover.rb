...
class PowerstoreImportStorageCenterDiscoverTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/import_storage_center/%{id}/discover'
  ...
  if __FILE__ == $0
    PowerstoreImportStorageCenterDiscoverTask.run
  end
