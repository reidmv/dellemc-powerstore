...
class PowerstoreX509CertificateDecommissionCertificatesTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/x509_certificate/decommission'
  ...
  if __FILE__ == $0
    PowerstoreX509CertificateDecommissionCertificatesTask.run
  end
