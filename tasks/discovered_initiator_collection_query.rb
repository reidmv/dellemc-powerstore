...
class PowerstoreDiscoveredInitiatorCollectionQueryTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/discovered_initiator'
  ...
  if __FILE__ == $0
    PowerstoreDiscoveredInitiatorCollectionQueryTask.run
  end
