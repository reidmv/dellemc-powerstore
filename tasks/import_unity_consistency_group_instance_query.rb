...
class PowerstoreImportUnityConsistencyGroupInstanceQueryTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/import_unity_consistency_group/%{id}'
  ...
  if __FILE__ == $0
    PowerstoreImportUnityConsistencyGroupInstanceQueryTask.run
  end
