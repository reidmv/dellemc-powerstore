...
class PowerstoreHardwareDriveRepurposeTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/hardware/%{id}/drive_repurpose'
  ...
  if __FILE__ == $0
    PowerstoreHardwareDriveRepurposeTask.run
  end
