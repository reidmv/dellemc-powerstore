...
class PowerstoreMigrationRecommendationInstancequeryTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/migration_recommendation/%{id}'
  ...
  if __FILE__ == $0
    PowerstoreMigrationRecommendationInstancequeryTask.run
  end
