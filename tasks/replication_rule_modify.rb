...
class PowerstoreReplicationRuleModifyTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_path = '/replication_rule/%{id}'
  ...
  if __FILE__ == $0
    PowerstoreReplicationRuleModifyTask.run
  end
