...
class PowerstoreMigrationRecommendationStartMigrationSessionsTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/migration_recommendation/%{id}/start_migration_sessions'
  ...
  if __FILE__ == $0
    PowerstoreMigrationRecommendationStartMigrationSessionsTask.run
  end
