...
class PowerstoreImportUnityConsistencyGroupCollectionQueryTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Get'
    operation_path = '/import_unity_consistency_group'
  ...
  if __FILE__ == $0
    PowerstoreImportUnityConsistencyGroupCollectionQueryTask.run
  end
