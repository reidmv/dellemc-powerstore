...
class PowerstoreImportUnityVolumeImportSnapshotSchedulesTask < TaskHelper
  ...
  def task(arg_hash)
    ...
    operation_verb = 'Post'
    operation_path = '/import_unity_volume/%{id}/import_snapshot_schedules'
  ...
  if __FILE__ == $0
    PowerstoreImportUnityVolumeImportSnapshotSchedulesTask.run
  end
