...
class PowerstoreVolumeModifyTask < TaskHelper
  ...
  def format_params(key_values)
    ...
    op_params = [
      ...
      op_param('node_affinity', 'body', 'node_affinity', 'node_affinity'),
  ...
  if __FILE__ == $0
    PowerstoreVolumeModifyTask.run
  end
