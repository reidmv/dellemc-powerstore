...
describe 'powerstore_nas_server' do
  it 'performs nas_server_collection_query' do
  ...
  it 'performs nas_server_ping' do
  ...
  it 'performs nas_server_update_user_mappings' do
  ...
  it 'performs nas_server_upload_group' do
  ...
  it 'performs nas_server_upload_homedir' do
  ...
  it 'performs nas_server_upload_hosts' do
  ...
  it 'performs nas_server_upload_netgroup' do
  ...
  it 'performs nas_server_upload_nsswitch' do
  ...
  it 'performs nas_server_upload_ntxmap' do
  ...
  it 'performs nas_server_upload_passwd' do
