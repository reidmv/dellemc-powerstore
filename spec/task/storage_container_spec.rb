...
describe 'powerstore_storage_container' do
  it 'performs storage_container_collection_query' do
  ...
  it 'performs storage_container_mount' do
  ...
  it 'performs storage_container_unmount' do
