...
describe 'powerstore_file_system' do
  it 'performs file_system_collection_query' do
  ...
  it 'performs file_system_clone' do
  ...
  it 'performs file_system_refresh' do
  ...
  it 'performs file_system_refresh_quota' do
  ...
  it 'performs file_system_restore' do
  ...
  it 'performs file_system_snapshot' do
