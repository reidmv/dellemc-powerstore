...
describe 'powerstore_volume_group' do
  it 'performs volume_group_collection_query' do
  ...
  it 'performs volume_group_add_members' do
  ...
  it 'performs volume_group_clone' do
  ...
  it 'performs volume_group_refresh' do
  ...
  it 'performs volume_group_remove_members' do
  ...
  it 'performs volume_group_restore' do
  ...
  it 'performs volume_group_snapshot' do
