...
ensure_module_defined('Puppet::Provider::PowerstoreVolume')
require 'puppet/provider/powerstore_volume/powerstore_volume'

# rubocop:disable RSpec/FilePath
RSpec.describe Puppet::Provider::PowerstoreVolume::PowerstoreVolume do
