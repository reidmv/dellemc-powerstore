...
ensure_module_defined('Puppet::Provider::PowerstoreHost')
require 'puppet/provider/powerstore_host/powerstore_host'

# rubocop:disable RSpec/FilePath
RSpec.describe Puppet::Provider::PowerstoreHost::PowerstoreHost do
