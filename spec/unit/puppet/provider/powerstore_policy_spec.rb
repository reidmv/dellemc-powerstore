...
ensure_module_defined('Puppet::Provider::PowerstorePolicy')
require 'puppet/provider/powerstore_policy/powerstore_policy'

# rubocop:disable RSpec/FilePath
RSpec.describe Puppet::Provider::PowerstorePolicy::PowerstorePolicy do
