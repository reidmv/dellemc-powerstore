...
class Puppet::Provider::PowerstoreFileKerberos::PowerstoreFileKerberos
  ...
  def build_create_hash(resource)
    ...
    file_kerberos['nas_server_id'] = resource[:nas_server_id] unless resource[:nas_server_id].nil?
  ...
  def self.invoke_list_all(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/file_kerberos', 'Get','application/json')
  end
  ...
  def self.invoke_create(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/file_kerberos', 'Post','application/json')
  end
  ...
  def self.invoke_update(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/file_kerberos/%{id}', 'Patch','application/json')
  end
  ...
  def self.invoke_delete(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/file_kerberos/%{id}', 'Delete','application/json')
  end
  ...
  def self.invoke_get_one(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/file_kerberos/%{id}', 'Get','application/json')
  end
