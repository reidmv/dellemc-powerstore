...
class Puppet::Provider::PowerstoreFileDns::PowerstoreFileDns
  ...
  def self.invoke_list_all(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/file_dns', 'Get','application/json')
  end
  ...
  def self.invoke_create(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/file_dns', 'Post','application/json')
  end
  ...
  def self.invoke_update(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/file_dns/%{id}', 'Patch','application/json')
  end
  ...
  def self.invoke_delete(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/file_dns/%{id}', 'Delete','application/json')
  end
  ...
  def self.invoke_get_one(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/file_dns/%{id}', 'Get','application/json')
  end
