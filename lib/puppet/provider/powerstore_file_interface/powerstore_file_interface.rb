...
class Puppet::Provider::PowerstoreFileInterface::PowerstoreFileInterface
  ...
  def self.invoke_list_all(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/file_interface', 'Get','application/json')
  end
  ...
  def self.invoke_create(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/file_interface', 'Post','application/json')
  end
  ...
  def self.invoke_update(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/file_interface/%{id}', 'Patch','application/json')
  end
  ...
  def self.invoke_delete(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/file_interface/%{id}', 'Delete','application/json')
  end
  ...
  def self.invoke_get_one(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/file_interface/%{id}', 'Get','application/json')
  end
