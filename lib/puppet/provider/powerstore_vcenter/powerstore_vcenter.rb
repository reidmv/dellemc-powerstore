...
class Puppet::Provider::PowerstoreVcenter::PowerstoreVcenter
  ...
  def self.invoke_list_all(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/vcenter', 'Get','application/json')
  end
  ...
  def self.invoke_create(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/vcenter', 'Post','application/json')
  end
  ...
  def self.invoke_update(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/vcenter/%{id}', 'Patch','application/json')
  end
  ...
  def self.invoke_delete(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/vcenter/%{id}', 'Delete','application/json')
  end
  ...
  def self.invoke_get_one(context, resource = nil, body_params = nil)
    ...
    context.transport.call_op(path_params, query_params, header_params, body_params, '/vcenter/%{id}', 'Get','application/json')
  end
